...
//    }
    ...
    public User getLoginUser(HttpServletRequest request) {
        ...
        return currentUser;
        // 走缓存
        // return StpUtil.getSessionByLoginId(loginUserId).get(USER_LOGIN_STATE);
    }
